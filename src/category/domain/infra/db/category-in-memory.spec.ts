...
describe('CategoryInMemoryRepository', () => {
    ...
    it('should sort by created_at when sort param is null', async () => {
        ...
        const items = [
            ...
            Category.fake().aCategory().withCreatedAt(new Date(created_at.getTime() + 100)).build(),
            Category.fake().aCategory().withCreatedAt(new Date(created_at.getTime() + 200)).build(),
        ];
