...
import { LoadEntityError } from '@core/category/domain/validators/validation.error'
import { setupSequelize } from '@core/shared/infra/testing/helpers'
import * as CastMemberSequelize from '@core/cast-member/infra/db/sequelize/cast-member-sequelize.repository'
